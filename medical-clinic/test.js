const { addDays, format, formatISO, getDay, isTuesday, getHours, subDays, getMinutes } = require('date-fns/fp');
const availDays = [
  {
...
console.log(getMinutes(new Date(formatISO(subDays(1)(new Date())))));
